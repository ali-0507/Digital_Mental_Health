        ...
        <div className="row">
          ...
          <div className="col-3 d-flex justify-content-end align-items-end ">
            <ul className="list-unstyled d-flex flex-row flex-md-column gap-3 mt-5 footer-links">
              ...
              <div className="text-center mt-0">
                <img src="./src/assets/logo_dmh.png" alt="Logo" className="footer-logo img-fluid my-2"/>
              </div>
          ...
          <div className="col-3 d-flex justify-content-center align-items-center">
            <ul className="list-unstyled d-flex flex-row flex-md-column gap-3 mt-4 footer-links">
              ...
              <li className="fs-6 text-center"> <a href="/chat"> About Us </a></li>
              <li className="fs-6 text-center me-2"> <a href="/booking">Booking </a></li>
              <li className="fs-6 text-center"> <a href="/resources"> AI Support </a></li>
              <li className="fs-6 text-center">  <a href="/"> Resources </a></li>
            </ul>
          </div>
